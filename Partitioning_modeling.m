...
v_SARS2_1daypre_98 = 10.01992; %SARS-CoV-2 viral load (98th cp), -1 day {log10 copies/ml}

v_SARS2_1daypost = 7.00; %SARS-CoV-2 mean viral load, -1 day {log10 copies/ml}
v_SARS2_1daypost_98 = 11.40318; %SARS-CoV-2 viral load (98th cp), -1 day {log10 copies/ml}

v_H1N1 = 6.81; %A(H1N1)pdm09 mean viral load {log10 copies/ml}
v_H1N1_98 = 9.49969; %A(H1N1)pdm09 viral load (98th cp), top 10% {log10 copies/ml}

gamma = 0.1e-2; %viability proportion {%}

d = linspace(0.1,100,301)'*1e-6; %particle diameters {m}
